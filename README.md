...
สามารถเช็คได้ว่า key โดนบันทึกจริงมั้ย โดยการปิด-เปิด window powershell แล้วพิม echo $Env:TYPHOON_API_KEY มันจะขึ้นประมาณ sk-xxxxxxxxxxxxxxxxxxxxxxxx
...
needs_transport	เดินทาง
needs_utilities สาธารณูปโภค
needs_insurance	ประกัน
needs_debt	หนี้
wants_misc	ค่าใช้จ่ายไม่จำเป็น
